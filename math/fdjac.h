...
*   be evaluated, ff[0,...,dimension-1] is the vector of function values at the*
*   point, vfunct( dimension, xx, ff) is a user-supplied routine that returns  *
*   the vector of functions at xx.                                             *
