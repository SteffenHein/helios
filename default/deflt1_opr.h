...
/* defaults: structure/reference line; time/frequency domain: */
   ...
   opr.n[2] = 0; /* 0/1: fixed CW power / maximum inner conductor temperature */
   ...
   opr.n[8] = 3; /* 0/1/2/3: no / mantle / pipe / both side temperature(s) fixed */
   opr.n[9] = 0; /* 0/1/2/3: no / mantle / pipe / both side heat outflow(s) fixed */
